"""
Django settings for django_kt project.
...
def read_env_variable(key=None, default=None):
    ...
    Example:
        ...
        nomenclature for environment variables, DJANGO_KT_<KEY_NAME>

        >>> read_env_variable('DJANGO_KT_SECRET_KEY', 'secret_key_value')
...
INSTALLED_APPS = DJANGO_APPS + DJANGO_KT_APPS + THIRD_PARTY_APPS
...
WSGI_APPLICATION = 'django_kt.wsgi.application'
...
DB_NAME = read_env_variable('DJANGOKT_DB_NAME')
DB_USER = read_env_variable('DJANGOKT_DB_USER_NAME')
DB_PASSWORD = read_env_variable('DJANGOKT_DB_USER_PASSWORD')
DB_HOST = read_env_variable('DJANGOKT_DB_HOST')
DB_PORT = int(read_env_variable('DJANGOKT_DB_PORT', '5432'))
...
AUTHENTICATION_BACKENDS = (
    'django_kt.accounts.backends.UserAuthenticationBackend',
)
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'django_kt.accounts.backends.UserJWTAuthenticationBackend',
    ],
